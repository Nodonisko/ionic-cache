...
describe('CacheService', () => {
    ...
    describe('when cache is enabled', () => {
      describe('when saving an object', () => {
        ...
        it('should save the json string to storage', async () => {
          ...
          expect(dependencies.cacheStorageService.set).toHaveBeenCalledWith(
            mockKey,
            {
              value: mockDataJson,
  ...
  describe('removeItem', () => {
    ...
    describe('when cache is enabled', () => {
      ...
      it('should remove the item in storage', () => {
        expect(dependencies.cacheStorageService.remove).toHaveBeenCalledWith(
          mockKey
        );
      });
    });
    ...
    describe('when cache is enabled', () => {
      describe('when the item exists in storage', () => {
        ...
        it('should get the data from storage', () => {
          expect(dependencies.cacheStorageService.get).toHaveBeenCalledWith(
            mockKey
          );
        });
      });
  ...
  describe('itemExists', () => {
    describe('when cache is enabled', () => {
      ...
      it('should check if the key exists in storage', () => {
        expect(dependencies.cacheStorageService.exists).toHaveBeenCalledWith(
          mockKey
        );
      });
    });
  ...
  describe('getOrSetItem', () => {
    ...
    describe('when the item does not exist', () => {
      ...
      beforeEach(() => {
        dependencies.cacheStorageService.get.and.returnValue(Promise.reject());
